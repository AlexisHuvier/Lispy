...
@lispy_function("lpg:entity:add", ["Entity", "PositionComponent|ShowComponent|TextComponent|SpriteComponent|ControlComponent|CollisionComponent|PhysicsComponent|ClickComponent|MoveComponent"], "Adding Component to Entity")
